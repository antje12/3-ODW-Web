...
<ul>
    ...
    <li>{@link org.jhotdraw.draw.CompositeFigure}</li> 
    <li>{@link org.jhotdraw.draw.ConnectionFigure}</li> 
    <li>{@link org.jhotdraw.draw.Connector}</li>
</ul>
<p>
...
<ul>
    ...
    <li>{@link org.jhotdraw.draw.Tool}</li>
    <li>{@link org.jhotdraw.draw.Handle}</li>
</ul>
<p>
The key interfaces for loading and saving a drawing, and for providing
copy and paste functionality are: 
</p>
<ul>
    <li>{@link org.jhotdraw.draw.InputFormat}</li>
